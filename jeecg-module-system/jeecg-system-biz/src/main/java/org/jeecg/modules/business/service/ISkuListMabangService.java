...
public interface ISkuListMabangService extends IService<SkuData> {
   ...
   String parseSkuToProduct(String erpCode) throws Exception;
    ...
    ResponsesWithMsg<String, String> publishSkuToMabang(List<SkuOrderPage> skuList);
    ...
    ResponsesWithMsg<String, String> mabangSkuWeightUpdate(List<SkuWeight> skuWeights);
