...
public class SkuWeightController extends JeecgController<SkuWeight, ISkuWeightService> {
    ...
    */
    ...
    public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		ResponsesWithMsg<String, String> responses = new ResponsesWithMsg<>();
		...
		for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
			...
			try (InputStream inputStream = file.getInputStream()){
				...
				ResponsesWithMsg<String, String> mabangResponses = skuListMabangService.mabangSkuWeightUpdate(skuWeights);
	...
	public Result<?> updateBatch(@RequestBody SkuWeightParam param) {
		...
		ResponsesWithMsg<String, String> responses = skuListMabangService.mabangSkuWeightUpdate(skuWeights);
		List<SkuWeight> skuWeightSuccesses = new ArrayList<>();
