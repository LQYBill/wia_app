...
WITH shipping AS (
    SELECT
        ...
        COALESCE(s.payment_document, p.payment_document) AS payment_document_string,
        ...
        CASE
            ...
            WHEN COALESCE(s.payment_document, p.payment_document, '') <> '' THEN 'proof_uploaded'
            ELSE 'pending'
    ...
    LEFT JOIN purchase_order p
        ON s.invoice_number = p.invoice_number
...
purchase AS (
    SELECT
        ...
        p.payment_document AS payment_document_string,
        ...
        CASE
            ...
            WHEN COALESCE(p.payment_document, '') <> '' THEN 'proof_uploaded'
            ELSE 'pending'
        END AS payment_status,
