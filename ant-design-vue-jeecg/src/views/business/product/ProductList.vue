...
<script>
  ...
  export default {
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title:'敏感属性ID',
            align:"center",
            dataIndex: 'sensitiveAttributeId_dictText'
          },
          {
            title:'重量，单位为克',
            align:"center",
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
         fieldList.push({type:'string',value:'code',text:'商品代码',dictCode:''})
         fieldList.push({type:'string',value:'zhName',text:'中文名',dictCode:''})
